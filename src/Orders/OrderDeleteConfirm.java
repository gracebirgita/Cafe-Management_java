...
public class OrderDeleteConfirm extends javax.swing.JFrame {

    String deletedItem;
    
    public OrderDeleteConfirm(String deletedID) {
        initComponents();
...
//        } else {
          deleteLabel.setText("Are you sure want to delete id \"" + deletedID +"  \" ?");
//        }
    }
    
    public OrderDeleteConfirm(){
         initComponents();
        this.setVisible(true);
...
//        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderDeleteConfirm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
