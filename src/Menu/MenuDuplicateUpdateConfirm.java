...
public class MenuDuplicateUpdateConfirm extends javax.swing.JFrame {

    String updateName, updateID, updateStock, updatePrice, updateImg;
    
    public MenuDuplicateUpdateConfirm(String updateName, String updateID, String updateStock,String updatePrice, String updateImg) {
        initComponents();
        ...
        deleteLabel.setText("This Menu Already exist, Want to Update it\" ?");
    }
    
    public MenuDuplicateUpdateConfirm(){
        initComponents();
        this.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuDuplicateUpdateConfirm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuDuplicateUpdateConfirm();
            }
        });
    }
